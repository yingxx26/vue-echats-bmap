<template>
  <div>
    ...
    <div class="mapDiv1">
      ...
      <a style="line-height:24px;color:#E74C3C;font-weight:bolder;" class="img1"><span
        style="color:#fff;font-weight:bolder;margin-left:50px">改造开始</span></a>
      <a style="line-height:24px;color:#89E73C;font-weight:bolder;" class="img2"><span
        style="color:#fff;font-weight:bolder;margin-left:50px">改造完成</span></a>
      <a style="line-height:24px;color:#E7E33C;font-weight:bolder;" class="img3"><span
        style="color:#fff;font-weight:bolder;margin-left:50px">投入使用</span></a>
      <a style="line-height:24px;color:#3CDCE7;font-weight:bolder;" class="img4"><span
        style="color:#fff;font-weight:bolder;margin-left:50px">完成验收</span></a>
    </div>
  </div>
</template>
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            var textContent = '<p style="margin-top: 20px; pointer-events: none">' +
                0 + '</p>' + '<p style="pointer-events: none">' +
                0 + '套</p>';
            var regionPoint = new BMap.Point(121.388495, 31.171609);
...
//////////////////////////区域边界////////////////////////////////
            var polygonContext = {};
            polygonContext[textContent] = []; // 点
            var boundary = new BMap.Boundary();
            boundary.get("上海市徐汇区", function (rs) { // 获取行政区域
